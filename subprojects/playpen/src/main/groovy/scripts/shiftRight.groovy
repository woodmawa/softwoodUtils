...
def comb = { println "clos 'add one' with $it"; it + 1 } >> { println " clos times 2 $it";
    it * 2 } >> { println " clos times 4 $it"; it * 4 }
v << comb(1)
...
v.then { println "times 2"; it * 2 } then { println "times 4"; it * 4 } then { println "deposit answer in ans";
    ans << it }
