...
class GroovyClassUtils {
    ...
    def primativeValueFromWrapper ( wrapper) {
        Class primativeType = wrapperToPrimativeMap.get (wrapper.getClass())

        assert primativeType

        String primativeName = primativeType.simpleName

        def unwrapped = wrapper."${primativeName}.Value"()
        unwrapped
    }
