...
class TestBasicConditionSpec extends Specification {
    ...
    def "test logical and/or of conditions"() {
        ...
        Condition condition1 = RuleFactory.newCondition(name: "c1#", description : "my first condition"){5 > 10}
        Condition condition2 = RuleFactory.newCondition(name: "c2#", description : "my second condition"){10 <20}
        ...
        def  result1 = condition1.test()
        def  result2 = condition2.test()
        def  res1OrRes2 = con1OrCon2.test()
        def  res1AndRes2 = con1AndCon2.test()
