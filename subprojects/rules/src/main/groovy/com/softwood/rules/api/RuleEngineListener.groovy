...
/**
 * A listener for com.softwood.rules engine execution events.
 *
 * @author Will Woodman
 */
public interface RuleEngineListener {
     ...
     *
     * @param rules to fire
     * @param facts present before firing com.softwood.rules
     */
     ...
     *
     * @param rules fired
     * @param facts present after firing com.softwood.rules
     */
     ...
     * <strong>When this listener is used with a {@link InferenceRulesEngine}, this method will be triggered once after the execution of each candidate rule set in each iteration.</strong>
     *
     * @param com.softwood.rules fired
     * @param facts present after firing com.softwood.rules
     */
